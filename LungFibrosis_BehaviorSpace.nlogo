...
to setup
  ...
  ;random-seed ss ;added this line to ensure randomly distributed fibroblasts at the beginning
...
to go
  ...
  ifelse ticks < time_stop * 7 * 24 ; convert to hours
  ...
  [
    ...
    if number-of-myofibroblasts >= secrete-spill-collagenFraction * ifc [ secrete-spill-collagen]
...
;===============================   EXPORTS FOR BEHAVIOR SPACE - BEFORE
to export-world-and-image-before
  export-view (word "worldBefore-" behaviorspace-run-number ".png")
  export-world (word "worldBefore-" behaviorspace-run-number ".csv")
end

;===============================   EXPORTS FOR BEHAVIOR SPACE - AFTER
to export-world-and-image-after
  export-view (word "worldAfter-" behaviorspace-run-number ".png")
  export-world (word "worldAfter-" behaviorspace-run-number ".csv")
end
@#$#@#$#@
GRAPHICS-WINDOW
936
...
export-world-and-image-before</setup>
    <go>go</go>
    <postRun>export-world-and-image-after</postRun>
    <metric>total_world_collagen</metric>
    ...
    <enumeratedValueSet variable="s-pirf">
      <value value="0"/>
      <value value="1"/>
    </enumeratedValueSet>
